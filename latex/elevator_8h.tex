...
The function consist of a for loop that checks the order matrix and turns on the light is there is a order. It also turns on the stop light when the stopp button is pushed. 
